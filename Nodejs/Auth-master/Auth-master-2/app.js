...
var addRouter = require('./routes/add');// try to require a routing module
var catalogRouter = require('./routes/catalog');// try to require a routing module
...
mongoose.connect('mongodb+srv://katechen:010101@locallibrary-2m7tu.azure.mongodb.net/test?retryWrites=true&w=majority', 
...
app.use('/addpage', addRouter); // try to call express app.use() with URL path & var ref to routing module
app.use('/catalog', catalogRouter);// try to call express app.use() with URL path & var ref to routing module
